        ...
        <p class="msg-info">Your new product has approved</p>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{Auth::user()->pic}}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{Auth::user()->fname." ".Auth::user()->lname}}</p>
                        <p class="designattion mb-0">{{Auth::user()->uname}}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                    <li><button class="dropdown-item" href="{{ route('logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></button>
                    </li>
                    </form>
                </ul>
            </div>
